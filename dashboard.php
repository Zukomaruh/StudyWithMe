...
<body class="d-flex flex-column min-vh-100">
    ...
    <main class="container py-5">
        ...
        <?php
        // Alle aktiven Sessions mit User-Infos und Profilbild holen
        $sql = "
            SELECT
                s.session_id,
                u.name AS user_name,
        ...
        foreach ($activeSessions as $course => $sessions) {
            ...
            <section class="course-section p-3 rounded">
                ...
                <?php foreach ($sessions as $session):
                    ...
                    // Profilbild-Pfad formatieren
                    $profilePic = !empty($session['profile_pic']) ? substr($session['profile_pic'], 3) : "assets/img/defaultpp.jpg";
                ?>
